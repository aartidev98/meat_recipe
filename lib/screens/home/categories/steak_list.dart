                  ...
                  child: Container(
                    child: ListView.builder(
                      ...
                      itemBuilder: (ctx, index) {
                        return CardDinner(steak_model: steakModelArray[index]);
                      },
...
class CardDinner extends StatelessWidget {
  final steakModel? steak_model;

  const CardDinner({Key? key, this.steak_model}) : super(key: key);
      ...
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => DetailRecipeScreen(
                image: steak_model!.image,
                title: steak_model!.title,
                id: steak_model!.id,
                ingredient: steak_model!.ingredient,
                directions: steak_model!.directions,
                rating: steak_model!.rating)));
      },
      child: Padding(
                ...
                child: Material(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: AssetImage(steak_model!.image),
                          fit: BoxFit.cover),
                    ),
                  ),
                ),
